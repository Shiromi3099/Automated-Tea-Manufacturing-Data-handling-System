...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_GET['id'])) {
        ...
        $sql = "UPDATE aeration_dpt SET inchargeName='$inchargeName', date='$date', startHour='$startHour', startMinute='$startMinute', endHour='$endHour', endMinute='$endMinute', teaLeafTemperature='$teaLeafTemperature', atype='$atype', rmaterial='$rtype', measurement='$measurement', units='$unit', employeeCount='$employeeCount', MachineCount='$machineCount', Weight1='$weight1' WHERE id=$id";
...
<nav class="navbar navbar-dark  bg-dark">
    ...
    <div class="btn-group">
    <a href="dashaera.php" class="btn btn-secondary btn-sm">
  Back
</a>
