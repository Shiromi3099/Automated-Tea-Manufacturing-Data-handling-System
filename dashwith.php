...
$query = "SELECT * FROM withering_dpt";
$result = mysqli_query($conn, $query);

if (isset($_GET['searchDate'])) {
    $searchDate = $_GET['searchDate'];
    $query = "SELECT * FROM withering_dpt WHERE date = '$searchDate'";
} else {
    $query = "SELECT * FROM withering_dpt";
}
...
<head>
    <meta charset="utf-8">
    <title>Factory foDash.with</title>
    ...
    <div class="ms-3">
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-secondary navbar-dark sticky-top px-4 py-0">
                ...
                <form class="d-none d-md-flex ms-4" method="get" action="dashwith.php">
...
<div class="container-fluid1 pt-4 px-4">
                <div class="bg-secondary text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">Withering Department</h6>
                    </div>
                        ...
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            <thead>
                                <tr class="text-white">
                                    ...
                                    <th scope="col">Tea Leave Weight</th>
        ...
        <tr>
            ...
            <td>
                <a href="viewwith.php?id=<?php echo $row['id']; ?>" class="btn btn-secondary btn-sm">View</a>
                <!-- Edit Button -->
                <a href="editwith.php?id=<?php echo $row['id']; ?>" class="btn btn-secondary btn-sm">Edit</a>
                <!-- Delete Button -->
                <a href="withdel.php?id=<?php echo $row['id']; ?>" class="btn btn-danger btn-sm">Delete</a>
            </td>
        </tr>
        <?php
        }
