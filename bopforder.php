       ...
       <section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6"><img class="img-fluid" src="<?php echo $imagePaths['BOPF']; ?>" alt=""></div>
                    <div class="col-md-6">
                        <div class="small mb-1">Agarapatha Tea Plantation</div>
                        <h1 class="display-5 fw-bolder">Broken Orange Pekoe Fannings</h1>
                        
                        <p class="lead">This is one of the most common grade in Sri Lanka. Its characteristics include a neat, and fairly clear tea leaf which is smaller in size than the BOP. Its bright in color once brewed and has richness to its flavor.
                         </p>
                         <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                             <input type="number" name="order_weight" placeholder="Order Weight (in Kg)" required>
                              <input type="hidden" name="tetype" value="BOPF"> <!-- Hidden field for tea type -->
                ...
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    ...
                    <div class="col mb-5">
                        ...
                        <img class="img-fluid" src="<?php echo $imagePaths['BOP']; ?>" alt="">
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <h5 class="fw-bolder">BOP</h5>
                                </div>
                            </div>
                            <!-- Product actions-->
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="boporder.php">View option</a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col mb-5">
                        ...
                        <img class="img-fluid" src="<?php echo $imagePaths['BOP1']; ?>" alt="">
                            ...
                            <!-- Product actions-->
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="bop1order.php">View Option</a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col mb-5">
                        ...
                        <img class="img-fluid" src="<?php echo $imagePaths['OP']; ?>" alt="">
                            ...
                            <!-- Product actions-->
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="oporder.php">View option</a></div>
                            </div>
                        </div>
                    </div>
                </div>
