...
<section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6"><img class="img-fluid" src="<?php echo $imagePaths['FBOP']; ?>" alt=""> </div>
                    <div class="col-md-6">
                        <div class="small mb-1">Agarapatha Tea Plantation</div>
                        <h1 class="display-5 fw-bolder">Flowery Broken Orange Pekoe</h1>
                        <p class="lead">Grown at a low elevation in the southern part of Sri Lanka, where the sun is most intense but also has abundant rainfall as it is located in the tropical rain forest belt. As a result, the bushes grow fast and produce a tea which is renowned for its amber liquor with good strength.
                         </p>
                         <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                             <input type="number" name="order_weight" placeholder="Order Weight (in Kg)" required>
                              <input type="hidden" name="tetype" value="FBOP"> <!-- Hidden field for tea type -->
                ...
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    <div class="col mb-5">
                        ...
                        <img class="img-fluid" src="<?php echo $imagePaths['BOP']; ?>" alt=""> 
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="boporder.php">View options</a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col mb-5">
                    ...
                    <div class="col mb-5">
                        ...
                        <img class="img-fluid" src="<?php echo $imagePaths['OPA']; ?>" alt=""> 
                            ...
                            <!-- Product actions-->
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="opaorder.php">View options</a></div>
