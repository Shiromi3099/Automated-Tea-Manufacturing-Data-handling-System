...
$query = "SELECT * FROM shifting_dpt";
$result = mysqli_query($conn, $query);

if (isset($_GET['searchDate'])) {
    $searchDate = $_GET['searchDate'];
    $query = "SELECT * FROM shifting_dpt WHERE date = '$searchDate'";
} else {
    $query = "SELECT * FROM shifting_dpt";
}
    ...
    <div class="ms-3">
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-secondary navbar-dark sticky-top px-4 py-0">
                ...
                <form class="d-none d-md-flex ms-4" method="get" action="dashshift.php">
...
<div class="container-fluid1 pt-4 px-4">
                <div class="bg-secondary text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">Shifting Department</h6>
                    </div>
    ...
    <tr>
        ...
        <td>
            <a href="viewshift.php?id=<?php echo $row['id']; ?>" class="btn btn-secondary btn-sm">View</a>
            <!-- Edit Button -->
            <a href="editshift.php?id=<?php echo $row['id']; ?>" class="btn btn-secondary btn-sm">Edit</a>
            <!-- Delete Button -->
            <a href="shiftdel.php?id=<?php echo $row['id']; ?>" class="btn btn-danger btn-sm">Delete</a>
        </td>
    </tr>
    <?php
    }
