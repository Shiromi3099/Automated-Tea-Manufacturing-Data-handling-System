...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_GET['id'])) {
        ...
        $sql = "UPDATE users SET username='$uname', address='$address', contact_number='$cNum', user_type='$uType', email='$email', Password='$password', confirm_password='$cpassword' WHERE id=$id";
    ...
    <div class="col-xxl-4 col-xl-5 col-lg-5 col-md-7 col-sm-9">
      ...
      <div class="card shadow-lg">
        <div class="card-body p-5">
          <h1 class="fs-4 card-title fw-bold mb-4">User Update Form</h1>
