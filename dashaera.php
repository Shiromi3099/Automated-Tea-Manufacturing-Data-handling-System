...
$query = "SELECT * FROM aeration_dpt";
$result = mysqli_query($conn, $query);

if (isset($_GET['searchDate'])) {
    $searchDate = $_GET['searchDate'];
    $query = "SELECT * FROM aeration_dpt WHERE date = '$searchDate'";
} else {
    $query = "SELECT * FROM aeration_dpt";
}
    ...
    <div class="ms-3">
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-secondary navbar-dark sticky-top px-4 py-0">
                ...
                <form class="d-none d-md-flex ms-4" method="get" action="dashaera.php">
...
<div class="container-fluid1 pt-4 px-4">
                <div class="bg-secondary text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">Aeration Department</h6>
                    </div>
                        ...
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            <thead>
                                <tr class="text-white">
                                    ...
                                    <th scope="col">Aeration Type</th>
                                    <th scope="col">Tea Leave Temperature</th>
        ...
        <tr>
            ...
            <td>
                <a href="vieware.php?id=<?php echo $row['id']; ?>" class="btn btn-secondary btn-sm">View</a>
                <!-- Edit Button -->
                <a href="editare.php?id=<?php echo $row['id']; ?>" class="btn btn-secondary btn-sm">Edit</a>
                <!-- Delete Button -->
                <a href="aeradel.php?id=<?php echo $row['id']; ?>" class="btn btn-danger btn-sm">Delete</a>
            </td>
        </tr>
        <?php
        }
