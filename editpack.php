...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $tetype=$_POST["Tea_Type"];
    $weight1 = $_POST["Weight1"];
    $count=$_POST["count"];

    if (isset($_GET['id'])) {
        $id = $_GET['id'];
        $sql = "UPDATE packing_dpt SET inchargeName='$inchargeName', date='$date', startHour='$startHour', startMinute='$startMinute', endHour='$endHour', endMinute='$endMinute', employeeCount='$employeeCount',tetype='$tetype', Weight1= '$weight1',count='$count' WHERE id=$id";
...
<html lang="en">
      ...
      <head>
        <meta charset="utf-8">
       <title> Factroy officer page</title>
    ...
    <div class="btn-group">
    <a href="dashpack.php" class="btn btn-secondary btn-sm">
 Back
</a>
 ...
 <div class="d-flex justify-content-center">
      ...
      <form id="WitheringForm" action="" method="POST" class="needs-validation" novalidate autocomplete="off">
        ...
        <div class="form-row">
          <div class="form-group col-md-4">
            ...
            <select class="form-control" id="inputTeaType" name="Tea Type" required>
  ...
  <script src="js/PAKING.js"></script>
</body>
