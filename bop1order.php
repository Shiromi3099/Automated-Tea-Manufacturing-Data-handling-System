...
<section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6"><img class="img-fluid" src="<?php echo $imagePaths['BOP1']; ?>" alt=""></div>
                    <div class="col-md-6">
                        <div class="small mb-1">Agarapatha Tea Plantation</div>
                        <h1 class="display-5 fw-bolder"> Broken Orange Pekoe One </h1>
                        
                        <p class="lead">  This Pure Ceylon black tea is a fine grade of tea. This tea is similar to OP1 Tea, but little smaller in size. It is made of smaller and slightly wiry tea leaves.
                         </p>
                         <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                             <input type="number" name="order_weight" placeholder="Order Weight (in Kg)" required>
                              <input type="hidden" name="tetype" value="BOP1"> <!-- Hidden field for tea type -->
